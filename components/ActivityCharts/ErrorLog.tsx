...
import type { ActivityData, ErrorEntry } from "@/pages/api/activity";
...
function LevelPill({ label, active, count, accentActive, countStyle, onClick }: LevelPillProps) {
...
export function ErrorLog({ data, cronJumpSeq = 0, containerRef }: ErrorLogProps) {
